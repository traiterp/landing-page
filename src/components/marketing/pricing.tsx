...
const Pricing = ({ dictionary }: ComponentProps) => {
...
const Plan = ({ plan, billPlan }: { plan: any, billPlan: Plan }) => {
    return (
        <div className={cn(
            ...
            plan.id === "crecimiento" && "border-blue-500"
        )}>
            {plan.id === "crecimiento" && (
